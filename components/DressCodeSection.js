export default function DressCodeSection() {
  return (
    <section className="py-12 px-8 text-center relative">
      ...
      <p className="text-sm text-[#4A3B32]/85 leading-relaxed max-w-[300px] mx-auto mb-6">
      ...
      <div className="flex justify-center gap-6 mt-6">
        <div className="flex flex-col items-center gap-2">
          ...
          <span className="text-xs uppercase tracking-widest font-bold text-[#4A3B32]/60">Branco</span>
        </div>
        <div className="flex flex-col items-center gap-2">
          ...
          <span className="text-xs uppercase tracking-widest font-bold text-[#4A3B32]/60">Off-white</span>
        </div>
      </div>
    </section>
  );
